	...
	protected void addIngoingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Node_ingoing_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Node_ingoing_feature", "_UI_Node_type"),
				 PetrinetPackage.Literals.NODE__INGOING,
				 true,
				 false,
				 true,
				 null,
