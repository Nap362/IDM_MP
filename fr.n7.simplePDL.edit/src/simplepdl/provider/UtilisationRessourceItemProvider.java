 ...
 * @generated
 */
public class UtilisationRessourceItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UtilisationRessource_quantiteMax_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UtilisationRessource_quantiteMax_feature", "_UI_UtilisationRessource_type"),
				 SimplepdlPackage.Literals.UTILISATION_RESSOURCE__QUANTITE_MAX,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SimplepdlPackage.Literals.UTILISATION_RESSOURCE__WORK_DEFINITION,
				 false,
				 false,
				 false,
				 null,
	...
	public String getText(Object object) {
		...
		return getString("_UI_UtilisationRessource_type") + " " + utilisationRessource.getQuantiteMax();
	}
