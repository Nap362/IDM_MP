...
public class PetrinetPackageImpl extends EPackageImpl implements PetrinetPackage {
	 ...
	 */
	@Override
	public EReference getNode_Reseau() {
	...
	public void createPackageContents() {
		...
		createEReference(nodeEClass, NODE__RESEAU);
	...
	public void initializePackageContents() {
		...
		initEReference(getNode_Reseau(), this.getPetriNet(), this.getPetriNet_Nodes(), "reseau", null, 0, 1, Node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
